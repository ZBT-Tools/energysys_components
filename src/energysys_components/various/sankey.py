...
def sankey_input_single(res: pd.Series) -> (dict, dict):
    ...
    node_def = [dict(label="Source_mc", color="rgba(0,0,0,0)", id=0),
                dict(label="Source_sd1", color="rgba(0,0,0,0)", id=1),
                dict(label="Source_sd2", color="rgba(0,0,0,0)", id=2),
                dict(label="Comp", color="#9e9da1", id=3),
                dict(label="Output", color="rgba(0,0,0,0)", id=4),
                dict(label="Loss", color="rgba(255,255,255,0)", id=5)]
