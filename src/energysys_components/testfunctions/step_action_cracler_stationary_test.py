...
import copy
import numpy as np
from src.energysys_components.energy_conversion_classes import EConversionParams, EConversionState, \
    EnergyConversion

# Example Definition
Cracker_fast = EConversionParams(P_out_rated=2000,
                                 P_out_min_pct=15,
                                 eta_main_pct=[[0, 100], [0.178 * 33.3 / 5.2, 0.178 * 33.3 / 5.2]],
                                 eta_all_pct=[
